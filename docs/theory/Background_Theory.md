...
| {math}`Q_v` | $$1$$ | $$\frac{\exp\left( -\frac{\omega_e}{2 k_B T} \right)}{1-\exp\left( -\frac{\omega_e}{k_B T} \right)}$$ | $$\prod_i\frac{\exp\left( -\frac{\omega_{e,i}}{2 k_B T} \right)}{1-\exp\left( -\frac{\omega_{e,i}}{k_B T} \right)}$$ | $$1$$ |
