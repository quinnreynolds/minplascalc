...
electrical conductivity :math:`\sigma`, thermal conductivity :math:`\kappa`, and total volumetric
...
for T in temperatures:
    ...
    electrical_conductivity.append(oxygen_mixture.calculate_electrical_conductivity())
...
# ----------
#
# The results obtained using minplascalc are reasonably comparable to other data for oxygen plasmas
# in literature, for example [Boulos2023]_.
# There are some differences, particularly in the thermal conductivity curve, and these are likely to
# result from the use of different collision integral calculations and other base data.
