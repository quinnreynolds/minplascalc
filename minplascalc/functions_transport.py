    ...
    for i in range(nb_species):
        for j in range(nb_species):
            ...
            for l in range(nb_species):
                ...
                sumval += term1 * term2
            q01[i, j] = (
                8 * number_densities[i] * (masses[i] / masses[j]) ** (3 / 2) * sumval
            )
    ...
    for i in range(nb_species):
        for j in range(nb_species):
            ...
            for l in range(nb_species):
                ...
                sumval += term1 * term2
            q02[i, j] = (
                8 * number_densities[i] * (masses[i] / masses[j]) ** (5 / 2) * sumval
            )
    ...
    for i in range(nb_species):
        for j in range(nb_species):
            ...
            for l in range(nb_species):
                ...
                sumval += term1 * term2
            q03[i, j] = (
                8 * number_densities[i] * (masses[i] / masses[j]) ** (7 / 2) * sumval
            )
    ...
    for i in range(nb_species):
        for j in range(nb_species):
            ...
            for l in range(nb_species):
                ...
                sumval += term1 * term2
            qhat00[i, j] = 8 * number_densities[i] * (masses[i] / masses[j]) * sumval
...
def viscosity(mixture: "LTE") -> float:
    ...
    b_vec[:nb_species] = (
        5 * number_densities * np.sqrt(2 * np.pi * masses / (u.k_b * mixture.T))
    )
