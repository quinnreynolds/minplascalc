def nist_string(nist_line: str) -> list[float]:
    ...
    ::
        ...
        ------------------------------------------------------------------------
          Observed      |     gA     | Acc. |       Ei           Ek       |Type|
         Wavelength     |   (s^-1)   |      |      (eV)         (eV)      |    |
          Vac (nm)      |            |      |                             |    |
        ------------------------------------------------------------------------
                        |            |      |                             |    |
              68.5544   |            |      |                             |    |
              74.4794   |            |      |   0.0000000  -   16.64678   |    |
              77.0793   | 7.74e+07   | C    |   0.0000000  -   16.08529   |    |
              77.1056   | 1.25e+08   | C+   |   0.0000000  -   16.07980   |    |
              77.5321   |            |      |   0.0000000  -   15.99133   |    |
                        |            |      |                             |    |
